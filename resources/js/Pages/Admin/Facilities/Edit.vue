...
const submit = () => {
    form.post(`/admin/facilities/${props.facility.id}?_method=PUT`, {
        forceFormData: true,
        onSuccess: () => alert('Berhasil update fasilitas!'),
    ...
    <AdminLayout>
        ...
        <div class="form-wrapper">
            ...
            <div class="form-header">
                <div class="header-icon-wrap">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="header-icon">
                        <path d="m21.731 2.269-2.592 2.592c-.53.53-.70.93-.633 1.35L19.5 10.5a.75.75 0 0 1-.216.534l-9 9A.75.75 0 0 1 9.75 20.25H4.5a.75.75 0 0 1-.75-.75v-5.25a.75.75 0 0 1 .22-.53l9-9A.75.75 0 0 1 13.5 4.5l4.29 1.002c.42.098.82-.102 1.35-.633l2.591-2.592a1 1 0 0 1 1 0Z"/>
                    </svg>
                </div>
                <div>
                    <h1 class="form-title">Edit Fasilitas</h1>
                    <p class="form-subtitle">Perbarui data fasilitas</p>
                </div>
            </div>
            ...
            <div class="form-card">
                ...
                <!-- CURRENT IMAGE STRIP -->
                <div v-if="facility.image && !previewUrl" class="current-img-strip">
                    <img :src="`/storage/${facility.image}`" class="current-img-thumb" alt="Foto saat ini" />
                    <div class="current-img-info">
                        <p class="current-img-label">Foto saat ini</p>
                        <p class="current-img-note">Upload foto baru untuk menggantinya</p>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="form-body">
                    ...
                    <div class="field-group">
                        ...
                        <div v-if="previewUrl" class="img-preview-wrap">
                            <img :src="previewUrl" class="img-preview" alt="Preview baru" />
                            <div class="img-preview-badge">Foto Baru</div>
                            <button type="button" @click="removePreview" class="img-preview-remove">
                        ...
                        <label v-else class="upload-zone">
                            ...
                            <span class="upload-text">Klik untuk pilih foto baru</span>
                            <span class="upload-hint">Kosongkan jika tidak ingin mengganti foto</span>
